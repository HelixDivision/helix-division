...
// Live checklist rather than relying on zod/RHF surfacing all four rule
// failures in one FieldError — more reliable and better UX (every rule's
// status is visible as the user types, not just after a failed submit).
